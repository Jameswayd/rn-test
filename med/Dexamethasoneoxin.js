    ...
    <ScrollView style={styles.container}>
      <View style={styles.row}>
        <View style={styles.column}>
          ...
          <Text style={styles.label}>NC00278100</Text>
      ...
      />
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
          <View style={frame.labelContainer}>
            ...
            <Text style={styles.label}>克僂強錠</Text>
        </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8  }}>
            ...
            <Text style={styles.label}>Dexamethasoneoxin</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>ODEXA</Text>
          </View>
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            <View style={frame.labelContainer}>
              <Text style={styles.label}>適應症:</Text>
            </View>
            <Text style={styles.label}>僂麻質樣關節炎、僂麻質熱、過敏性疾患、結合織炎及關節炎樣疾患、皮膚疾患、過敏性及炎症性眼科疾患等。</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>常見口乾舌燥，喝多尿多，長期或大量服用則可能出現腸胃不適、四肢浮腫等。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>1. 胃腸潰瘍病患使用時務需特別注意。2. 因可能引起浮腫及血壓上升，腎臟疾患及高血壓患者應特別注意。</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>dexamethasone 0.5mg</Text>
          </View>
          ...
          1. 初劑量：每日0.5～9mg維持劑量為初劑量的1/3～1/2。每12小時1次給藥，急性及致命性情況，劑量可提高數倍。2. 兒童應給予最低有效劑量(最好是口服)，劑量約為0.2mg/kg/24小時，分次使用。
          </Text>
...
export default Dexamethasoneoxin;
