    ...
    <ScrollView style={styles.container}>
      <View style={styles.row}>
        <View style={styles.column}>
          ...
          <Text style={styles.label}>B017124221</Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
          <View style={frame.labelContainer}>
            ...
            <Text style={styles.label}>安易醒</Text>
        </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8  }}>
            ...
            <Text style={styles.label}>Anexate</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>IANEX</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>本品可以做為中毒時證明診斷之因或排除中毒之用，亦適用於回轉benzodiazepine之中樞鎮靜作用。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>噁心、嘔吐、心悸。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>在注射後的24小時內勿駕車或操作危險性機械。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>Flumazenil Inj:0.5mg/Amp。
</Text>
          </View>
          ...
          <Text style={styles.label}>初劑量15秒內靜注0.2mg，若60秒內仍未恢復到希望的意識程度，再追加第二劑0.1mg，然後視需要每60秒追加1劑，直到總劑量1mg為止，常用劑量是0.3~0.6mg。
</Text>
