    ...
    <ScrollView style={styles.container}>
      <View style={styles.row}>
        <View style={styles.column}>
          ...
          <Text style={styles.label}>NC00817100</Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8  }}>
            ...
            <Text style={styles.label}>Dilantin</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>大發作及局部發作形癲癇、預防及治療神經外科手術所引起之癲癇發作。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>1. 依血中濃度調整劑量，使之維持於10-20μg/ml。2. 服用本品的患者不宜開車或從事危險性的工作。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>Diphenylhydantoin 100mg。
</Text>
          </View>
          ...
          <Text style={styles.label}>100mg/次，一天3次，之後視病患的狀況調整。
</Text>
