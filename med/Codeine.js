    ...
    <ScrollView style={styles.container}>
      <View style={styles.row}>
        <View style={styles.column}>
          ...
          <Text style={styles.label}>A005857100</Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
          <View style={frame.labelContainer}>
            ...
            <Text style={styles.label}>磷酸可待因錠
</Text>
        </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8  }}>
            ...
            <Text style={styles.label}>Codeine</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>主要為鎮咳，其他亦可用於胃痛、疝痛等場合之鎮靜、鎮痛。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>連用時易成癮、頭重腳輕、鎮靜發汗、噁心、呼吸抑制。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>疑似麻醉藥成癮的患者禁用
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>Codeine phosphate Tab:15mg。
</Text>
          </View>
          ...
          <Text style={styles.label}>成人：口服4~6小時1次，10~20mg/次，最大劑量每天120mg。6~12歲：每4~6小時服5~10mg，最大劑量每天60mg。2~6歲：每4~6小時服2.5~5mg，最大劑量每天30mg。
</Text>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
            ...
            <Image source={require('../assets/36.jpeg')} style={styles.image} />
          </View>
        </View>
      </View>
    </ScrollView>
