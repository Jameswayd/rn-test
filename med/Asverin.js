    ...
    <ScrollView style={styles.container}>
      <View style={styles.row}>
        <View style={styles.column}>
          ...
          <Text style={styles.label}>A008907100
</Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
          <View style={frame.labelContainer}>
            ...
            <Text style={styles.label}>安嗽錠</Text>
        </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8  }}>
            ...
            <Text style={styles.label}>Asverin</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>OASVE</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>失眠、眩暈、消化系統障礙、過敏
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>可能使尿液變淡紅色。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>Tipepidine Hibenzate Tab:20mg/Tab。
</Text>
          </View>
          ...
          <Text style={styles.label}>成人：口服每日3次，1~2粒/次，3~5歲每日15~40mg、1~2歲每日10~25mg、未滿1歲，每日5~20mg。
</Text>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
            ...
            <Image source={require('../assets/35.jpeg')} style={styles.image} />
          </View>
        </View>
      </View>
    </ScrollView>
