    ...
    <ScrollView style={styles.container}>
      <View style={styles.row}>
        <View style={styles.column}>
          ...
          <Text style={styles.label}>A037598116
</Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
          <View style={frame.labelContainer}>
            ...
            <Text style={styles.label}>愛克痰</Text>
        </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8  }}>
            ...
            <Text style={styles.label}>Actein</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>OENCO</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>緩解呼吸道黏液之蓄積、減輕支氣管阻塞併發症，減少呼吸道黏膜的黏稠性。Acetaminophen過量之解毒劑。</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>噁心、嘔吐、鼻漏、口炎、過敏反應。</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>Acetylcysteine與許多抗生素不能配合，因為形成不活性物質，如tetracycline, sod. Ampicille Enythromycin,如果一定要併用抗生素，此抗生素改以注射方式投與。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>Acetylcysteine granule:200mg/3gm/pack含Acetylcysteine 200mg。
</Text>
          </View>
          ...
          <Text style={styles.label}>成人：口服，1天3次，每次1pack。Acetaminophen解毒：起始劑量140mg/kg，與5%蘇打水溶液混合，每4小時連續投與17次，70mg/kg的維持劑量。
</Text>
