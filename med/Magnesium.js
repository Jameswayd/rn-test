    ...
    <ScrollView style={styles.container}>
      <View style={styles.row}>
        <View style={styles.column}>
          ...
          <Text style={styles.label}>A004771238</Text>
      ...
      />
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
          <View style={frame.labelContainer}>
            ...
            <Text style={styles.label}>硫酸鎂注射液</Text>
        </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8  }}>
            ...
            <Text style={styles.label}>Magnesium Sulfate</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>IMGSO</Text>
          </View>
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            <View style={frame.labelContainer}>
              <Text style={styles.label}>適應症:</Text>
            </View>
            <Text style={styles.label}>本品可用來控制與癲癇、子癲前症、懷孕毒血症、甲狀腺機能不足和其他臨床上血漿中鎂濃度低下的情況等有關的驚厥。</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>解毒方式 : 鈣離子製劑以靜脈注射補充。</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>Magnesium Sulfate Inj:10% 20ml/Amp</Text>
          </View>
          ...
          IM:1gm至2gm的10%~25%之溶液。IV:10%溶液每分鐘1.5ml，直到獲得所需的效應，癲癇時頭一次投予4g，之後每半小時IV:5ml(0.5g)。
          </Text>
