    ...
    <ScrollView style={styles.container}>
      <View style={styles.row}>
        <View style={styles.column}>
          ...
          <Text style={styles.label}>A040833157</Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
          <View style={frame.labelContainer}>
            ...
            <Text style={styles.label}>息咳寧糖漿</Text>
        </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8  }}>
            ...
            <Text style={styles.label}>Secorine</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8  }}>
            ...
            <Text style={styles.label}>糖漿</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>OSECO</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>緩解感冒之各種症狀（流鼻水、鼻塞、打噴嚏、喀痰）。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>發疹、嘔吐、食慾不振、頭暈、耳鳴。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>服藥後，請小心開車或操作危險機械。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>每ml含有: dl-Methylphedrine 1mg / Chlorpheniramine 0.1mg / Glyceryl guaiacolate 5mg
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
            ...
            <Image source={require('../assets/21.jpeg')} style={styles.image} />
          </View>
        </View>
      </View>
    </ScrollView>
