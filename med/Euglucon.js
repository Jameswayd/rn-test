    ...
    <ScrollView style={styles.container}>
      <View style={styles.row}>
        <View style={styles.column}>
          ...
          <Text style={styles.label}>A0028631G0</Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8  }}>
            ...
            <Text style={styles.label}>Euglucon
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>OEUGL</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center', marginBottom: 8 }}>
            ...
            <Text style={styles.label}>胃腸道不適、皮膚過敏。
</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row' , alignItems: 'center' , marginBottom: 8}}>
            ...
            <Text style={styles.label}>Glibenclamide（Glyburide） Tab:5mg。
</Text>
          </View>
          ...
          <Text style={styles.label}>初劑量每天2.5~5mg，然後每隔3~5天增加2.5~5mg，每天劑量範圍：2.5~20mg，小量時每天早餐時一次服用，大量時，宜分早晚兩次服用，應用飯時，用飯後馬上服用通常口服後3小時應開始作用，其作用可持續15個小時。
</Text>
